...
class Mute(commands.Cog):
    ...
    async def mute_member(self, interaction: Interaction, member: discord.Member, timestring, reason):
    ...
    async def mute(self, interaction: Interaction, member: discord.Member, duration: str, reason: Optional[str] = None):
        mute_error_embed = Embed(title="", color=discord.Colour.red())
        ...
        if member == self.bot.user:
            ...
            return await interaction.response.send_message(embed=mute_error_embed)
        await self.mute_member(interaction, member, duration, reason)
