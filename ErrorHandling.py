...
class NotBotOwnerError:
    def __repr__(self) -> str:
        return f"Sorry, you have no permission to perform this command.\n-# <a:EyeNormal:1274033692356116522> This command is only permitted to bot owner, team owner, team admins & developers • [Learn more](<https://discord.com/developers/docs/topics/teams#team-member-roles>)"
